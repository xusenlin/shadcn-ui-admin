...
export const Logo = () => {
  return (
      <svg  className="w-6 logo" viewBox="0 0 118.5926 99.2841">
        <path
        ...
        <rect className="fill-foreground" x="103.7963" y="60.5296" width="14.7963" height="24.7034" rx="2"/>
        <rect className="fill-foreground" y="60.5296" width="14.7963" height="24.7034" rx="2"/>
        <path className="fill-foreground"
